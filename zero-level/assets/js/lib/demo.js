 ...
 */
{
		...
		initEvents() {
			this.positionElement = (ev) => {
				...
				this.DOM.reveal.style.top = `${
					mousePos.y + 20 - docScrolls.top - 200
				}px`
				this.DOM.reveal.style.left = `${mousePos.x + 20 - docScrolls.left}px`
			}
			this.mouseenterFn = (ev) => {
	...
	;[
		...document.querySelectorAll('[data-fx="10"] > a, a[data-fx="10"]'),
	].forEach((link) => new HoverImgFx10(link))
	;[
		...document.querySelectorAll('[data-fx="11"] > a, a[data-fx="11"]'),
	].forEach((link) => new HoverImgFx11(link))
	;[
		...document.querySelectorAll('[data-fx="12"] > a, a[data-fx="12"]'),
	].forEach((link) => new HoverImgFx12(link))
	;[
		...document.querySelectorAll('[data-fx="13"] > a, a[data-fx="13"]'),
	].forEach((link) => new HoverImgFx13(link))
	;[
		...document.querySelectorAll('[data-fx="14"] > a, a[data-fx="14"]'),
	].forEach((link) => new HoverImgFx14(link))
	;[
		...document.querySelectorAll('[data-fx="15"] > a, a[data-fx="15"]'),
	].forEach((link) => new HoverImgFx15(link))
	;[
		...document.querySelectorAll('[data-fx="16"] > a, a[data-fx="16"]'),
	].forEach((link) => new HoverImgFx16(link))
	;[
		...document.querySelectorAll('[data-fx="17"] > a, a[data-fx="17"]'),
	].forEach((link) => new HoverImgFx17(link))
	;[
		...document.querySelectorAll('[data-fx="18"] > a, a[data-fx="18"]'),
	].forEach((link) => new HoverImgFx18(link))
	;[
		...document.querySelectorAll('[data-fx="19"] > a, a[data-fx="19"]'),
	].forEach((link) => new HoverImgFx19(link))
	;[
		...document.querySelectorAll('[data-fx="20"] > a, a[data-fx="20"]'),
	].forEach((link) => new HoverImgFx20(link))
	;[
		...document.querySelectorAll('[data-fx="21"] > a, a[data-fx="21"]'),
	].forEach((link) => new HoverImgFx21(link))
	;[
		...document.querySelectorAll('[data-fx="22"] > a, a[data-fx="22"]'),
	].forEach((link) => new HoverImgFx22(link))
	;[
		...document.querySelectorAll('[data-fx="23"] > a, a[data-fx="23"]'),
	].forEach((link) => new HoverImgFx23(link))
